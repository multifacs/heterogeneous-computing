...
int main(int argc, char *argv[]) {
  ...
  {
    auto result =
        jacobi::slauAccessor(A, b, iterationsLimit, accuracyTarget, queue);
  }
  ...
  {
    auto result =
        jacobi::slauSharedMemory(A, b, iterationsLimit, accuracyTarget, queue);
  }
  ...
  {
    auto result =
        jacobi::slauDeviceMemory(A, b, iterationsLimit, accuracyTarget, queue);
  }
  {
    auto result =
        jacobi::slauDeviceMemory(A, b, iterationsLimit, accuracyTarget, queue);
